export class PipeNetworkConfig {
    ...
    static GET_PIPES_DATA_URL = "http://192.168.16.231:8099/api/v1/article/monitor/pipelineModeling";
    static GET_WELLS_DATA_URL = "http://192.168.16.231:8099/api/v1/article/monitor/wellPointModeling";

    //获取（管道/管井）展示数据地址
    static GET_PIPE_PRESENT_DATA_URL = "http://192.168.16.231:8099/api/v1/article/monitor/pipelineId";
    static GET_WELL_PRESENT_DATA_URL = "http://192.168.16.231:8099/api/v1/article/monitor/wellPointId";
