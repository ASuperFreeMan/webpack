export class MarkConfig {
    constructor() {
        ...
        this.simpleMark3Config = {
            billboard: {
                uri: this.prefix + require("../static/map/map_point/SewagePlant.png").default,
                width: 200,
                height: 228.99
            }
        };
        ...
        this.simpleMarK1ImgUriRelations = {
            "error": this.prefix + require("../static/map/map_point/map_point1.png").default,
            "normal": this.prefix + require("../static/map/map_point/map_point2.png").default,
            "warning": this.prefix + require("../static/map/map_point/map_point3.png").default
        };
        // simpleMark2图片和状态对应关系
        this.simpleMark2ImgUriRelations = {
            "0": this.prefix + require("../static/map/map_point/map_icon1.png").default,
            "1": this.prefix + require("../static/map/map_point/map_icon2.png").default,
            "2": this.prefix + require("../static/map/map_point/map_icon3.png").default,
            "3": this.prefix + require("../static/map/map_point/map_icon4.png").default,
            "4": this.prefix + require("../static/map/map_point/map_icon5.png").default,
            "5": this.prefix + require("../static/map/map_point/point1.png").default,
            "6": this.prefix + require("../static/map/map_point/point2.png").default,
            "7": this.prefix + require("../static/map/map_point/point3.png").default,
            "8": this.prefix + require("../static/map/map_point/point4.png").default,
            "9": this.prefix + require("../static/map/map_point/point5.png").default,
        };
        // complexMarK1状态和图片对应关系
        this.complexMarK1ImgUriRelations = {
            "error": this.prefix + require("../static/map/map_point/map_point01.png").default,
            "normal": this.prefix + require("../static/map/map_point/map_point02.png").default,
            "warning": this.prefix + require("../static/map/map_point/map_point03.png").default
        };
