export class MapConfiguration {
    ...
    static pipeLineIconImgUris = [
        require("../static/map/pipeline/pipeline0.png").default,
        require("../static/map/pipeline/pipeline1.png").default,
        require("../static/map/pipeline/pipeline2.png").default,
        require("../static/map/pipeline/pipeline3.png").default
    ];
    // 路线图标经纬度
    ...
    // 高亮图片
    static lightImgUris = [
        require("../static/map/light/light_0.png").default,
        require("../static/map/light/light_1.png").default,
        require("../static/map/light/light_2.png").default,
        require("../static/map/light/light_3.png").default,
        require("../static/map/light/light_4.png").default,
        require("../static/map/light/light_5.png").default,
        require("../static/map/light/light_6.png").default
    ];
    // 高亮图片位置
